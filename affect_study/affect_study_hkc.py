    ...
    def __create_prompt(self, i, format_instructions):
        if i == 0:
            return PromptTemplate(template=(
                ...
                "As a Hong Kong Chinese undergraduate college student who was born, raised, and currently lives in Hong Kong, \
                whose parents and grandparents were born and raised in a Chinese context, \
                is more oriented to Chinese culture \
                and less oriented to American culture than Asian American or European American students,  \
...
logging.basicConfig(filename=fname + "_us_affect_study_hkc_final.log", encoding='utf-8', level=logging.DEBUG)
for i in range(1):  # choose n for how many times to run this survey
    df = analyzer.generate_response()
    df.to_csv("results/final/" + fname + "/us_affect_study_final_hkc" + fname + str(26+i))
